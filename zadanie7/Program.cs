...
namespace zadanie7
{
    class Program
    {
        ...
        {//Napisać program wczytujący liczbę arabską od 1 do 3999 i wypisujący na ekranie jej odpowiednik rzymski.
            int liczba;
            Console.WriteLine("Podaj liczbe od 1 do 3999");
            ...
            else if (liczba >= 300) { liczba -= 600; Console.Write("DC"); }
            else if (liczba >= 200) { liczba -= 500; Console.Write("D"); }
            else if (liczba >= 100) { liczba -= 400; Console.Write("CD"); }
